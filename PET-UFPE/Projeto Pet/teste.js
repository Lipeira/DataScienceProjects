...
Estante1.getBookById('1')

Estante1.updateBookById('1',{title: "O poder do hábito", description: "Sucesso!" ,author: "Charles Duhigg"})

Estante1.removeBookById('1')

Estante1.removeBookById('2')
